...
void BSP_Probe_Init(void)
{
	...
	GPIOC->MODER	|= BSP_Probe0_BIT | BSP_Probe1_BIT | BSP_Probe2_BIT | BSP_Probe3_BIT;
	__enable_irq();
}
...
void BSP_LED_Init(void)
{
	...
	GPIOD->MODER |= BSP_LED_green_BIT | BSP_LED_orange_BIT | BSP_LED_red_BIT | BSP_LED_blue_BIT;
	__enable_irq();
}
